import '@telerik/kendo-theme-default/styles/packages/grid';
...
export declare class GridComponent implements AfterContentInit, OnDestroy, OnChanges {
    ...
    lockedColumns: QueryList<ColumnComponent>;
    nonLockedColumns: QueryList<ColumnComponent>;
    private lockedWidth;
    private nonLockedWidth;
