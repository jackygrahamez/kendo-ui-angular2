 ...
 * @hidden
 */
export declare abstract class XAxisTitleComponentGenerated extends SettingsComponent {
    ...
    text: string;
    /**
     * If set to `true`, the Chart displays the x axis title of the Scatter Chart. By default, the x
     * axis title of the Scatter Chart is visible.
     */
    visible: boolean;
    /**
