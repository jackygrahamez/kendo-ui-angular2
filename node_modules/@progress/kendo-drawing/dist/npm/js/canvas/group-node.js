...
/***/ function(module, exports, __webpack_require__) {
	...
	var GroupNode = function (_Node) {
	    ...
	    function GroupNode() {
	        ...
	        return _possibleConstructorReturn(this, (GroupNode.__proto__ || Object.getPrototypeOf(GroupNode)).apply(this, arguments));
	    }
	...
	_traversable2.default.extend(GroupNode.prototype, "childNodes");

	_nodeMap2.default.Group = GroupNode;
