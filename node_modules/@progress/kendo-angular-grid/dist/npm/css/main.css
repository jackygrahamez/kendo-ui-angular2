...
.k-button {
  ...
  .k-button:active, .k-button.k-state-active {
    background-image: -webkit-linear-gradient(#f1f1f1, #f6f6f6);
...
.k-primary {
  color: #fff;
  background-color: #ff6358;
  background-image: -webkit-linear-gradient(#ff6b58, #ff6358);
  background-image: linear-gradient(#ff6b58, #ff6358);
  border-color: #ff6358; }
  .k-primary:hover {
    background-image: -webkit-linear-gradient(#ff7458, #ff6b58);
  ...
  .k-primary:active, .k-primary.k-state-active {
    background-image: -webkit-linear-gradient(#ff6358, #ff6b58);
  ...
  .k-primary .k-state-disabled:active {
    color: #fff;
    background-color: #ff6358;
    background-image: -webkit-linear-gradient(#ff7458, #ff6358);
...
.k-action-buttons {
  ...
  .k-action-buttons .k-primary {
    ...
    .k-action-buttons .k-primary:active {
      background-image: -webkit-linear-gradient(#fc655b, #ff6b58);
...
.k-window-titlebar {
  ...
  .k-window-titlebar .k-window-action {
    ...
    .k-window-titlebar .k-window-action .k-icon {
      margin: 0;
      vertical-align: top; }
    .k-window-titlebar .k-window-action:hover, .k-window-titlebar .k-window-action:focus {
      padding: 0.68571em;
      font-size: 0.875em;
      width: 1em; }
