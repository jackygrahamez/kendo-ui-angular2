 ...
 * @hidden
 */
export declare abstract class SeriesLabelsComponentGenerated extends SettingsComponent {
    ...
    visible: boolean;
    /**
     * A function that can be used to create a custom visual for the labels. The available argument fields
     * are:
     *
     ...
     *
     * The Chart displays the series from labels when either the `series.labels.visible` or
     ...
     *
     * The Chart displays the series to labels when either the `series.labels.visible` or
