...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComboBoxComponent = (function () {
	    ...
	    ComboBoxComponent.prototype.ngOnChanges = function (changes) {
	        var dataChanged = util_1.isChanged("data", changes);
	        var valueChanged = util_1.isChanged("value", changes);
	        if (valueChanged) {
	            //only when using [value] binding
	            this.verifySettings();
	        ...
	        else if (dataChanged || changes.data.isFirstChange()) {
	            if (this.text == null) {
	                this.setState(this.value);
	            }
	            else {
	    ...
	    ComboBoxComponent.prototype.setState = function (value) {
	        ...
	        if (result.dataItem) {
	            ...
	            //no dataItem resolved from this value
	            //do we want to display the value as text?
	    ...
	    ComboBoxComponent.prototype.search = function (value) {
	        //TODO: implement search that focuses the first item mathing the value argument
	    ...
	    ComboBoxComponent.prototype.change = function (dataItem, isCustom) {
	        if (isCustom === void 0) { isCustom = false; }
	        var customItem;
	        this.open = false;
	        if (isCustom) {
	            if (dataItem === this.value) {
	                return;
	            }
	            else {
	                customItem = (_a = {},
	                    _a[this.textField] = dataItem,
	                    _a[this.valueField] = undefined,
	                    _a
	                );
	            }
	        }
	        else if (this.dataItem === dataItem) {
	            return;
	        }
	        ...
	        this.onChangeCallback(this.valuePrimitive ? this.value : dataItem);
	        this.valueChange.emit(this.valuePrimitive ? this.value : dataItem);
	        var _a;
	    };
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object)
	    ], ComboBoxComponent.prototype, "value", void 0);
	    __decorate([
	        core_1.Input(), 
