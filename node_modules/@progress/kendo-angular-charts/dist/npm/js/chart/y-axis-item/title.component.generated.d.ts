 ...
 * @hidden
 */
export declare abstract class YAxisTitleComponentGenerated extends SettingsComponent {
    ...
    text: string;
    /**
     * If set to `true`, the Chart displays the Scatter Chart y-axis title. By default,
     * the Scatter Chart y-axis title is visible.
     */
    visible: boolean;
    /**
