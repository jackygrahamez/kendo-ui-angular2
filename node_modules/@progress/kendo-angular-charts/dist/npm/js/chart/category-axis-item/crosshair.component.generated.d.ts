 ...
 * @hidden
 */
export declare abstract class CategoryAxisCrosshairComponentGenerated extends SettingsComponent {
    ...
    opacity: number;
    /**
     * If set to `true`, the Chart displays the category axis crosshair. By default, the category axis
     * crosshair is not visible.
     */
    visible: boolean;
    /**
