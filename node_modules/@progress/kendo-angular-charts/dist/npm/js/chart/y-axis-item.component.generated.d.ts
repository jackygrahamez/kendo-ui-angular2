 ...
 * @hidden
 */
export declare abstract class YAxisItemComponentGenerated extends CollectionItemComponent {
     ...
     * If the `yAxis.type` is set to `"log"`, the `majorUnit` value is used for the base of the logarithm.
     */
    majorUnit: number;
    /**
    ...
    /**
     * The interval between minor divisions. It defaults to 1/5 of `yAxis.majorUnit`.
     * If `yAxis.type` is set to `"log"`, the `minorUnit` value represents the number of divisions between
     ...
     *
     * To display the title, set the `yAxis.title.text` option.
     */
    title: any;
