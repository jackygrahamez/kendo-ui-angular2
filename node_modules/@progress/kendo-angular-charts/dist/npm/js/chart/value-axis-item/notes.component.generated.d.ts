...
import { AxisNoteVisualArgs, NoteLine } from '../../common/property-types';
/**
 * @hidden
 */
export declare abstract class ValueAxisNotesComponentGenerated extends SettingsComponent {
     ...
     *
     * - `rect`&mdash;The `kendo.geometry.Rect` that defines the note target rect.
     * - `options`&mdash;The note options.
     * - `createVisual`&mdash;A function that can be used to get the default visual.
     * - `value`&mdash;The note value.
     */
    visual: (e: AxisNoteVisualArgs) => void;
    /**
