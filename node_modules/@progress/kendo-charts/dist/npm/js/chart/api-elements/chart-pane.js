...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chartSeries = __webpack_require__(38);
	...
	var ChartPane = function () {
	    function ChartPane(chart, pane) {
	        ...
	        value: function series() {
	            ...
	            if (series) {
	                for (var idx = 0; idx < series.length; idx++) {
	                    result.push(new _chartSeries2.default(chart, series[idx]));
	                }
	            }
...
/***/ function(module, exports) {
	...
	module.exports = require("./chart-series");
