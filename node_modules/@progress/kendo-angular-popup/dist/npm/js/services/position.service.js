...
/***/ function(module, exports, __webpack_require__) {
	...
	var dom_service_1 = __webpack_require__(19);
	...
	var PositionService = (function () {
	    ...
	    PositionService.prototype.positionElement = function (settings) {
	        ...
	        var scroll = settings.scroll || this._dom.scrollPosition(element);
	        ...
	        var elementRect = this._dom.removeScroll(this._dom.relativeOffset(element, currentLocation), scroll);
	        ...
	        return {
	            ...
	            offset: this._dom.addOffset(currentLocation, result.offset)
	        };
	    };
