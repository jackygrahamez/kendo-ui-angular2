...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListComponent = (function () {
	    function ListComponent(selectionService) {
	        ...
	        this.selectSubscribtion = this.selectionService.onSelect.subscribe(this.handleItemChange.bind(this));
	    }
	    ...
	    ListComponent.prototype.handleItemChange = function (event) {
	    ...
	    __decorate([
	        core_1.ViewChildren(list_item_directive_1.ListItem), 
...
/***/ function(module, exports) {
	...
	module.exports = require("./list-item.directive");
