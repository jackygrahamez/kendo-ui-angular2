 ...
 * @hidden
 */
export declare abstract class ValueAxisTitleComponentGenerated extends SettingsComponent {
    ...
    text: string;
    /**
     * If set to `true`, the Chart displays the value axis title. By default, the value axis title is
     * visible.
     */
    visible: boolean;
    /**
