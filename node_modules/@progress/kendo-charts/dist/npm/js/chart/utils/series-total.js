...
/***/ function(module, exports, __webpack_require__) {
	...
	var _segmentVisible = __webpack_require__(328);
	...
	function seriesTotal(series) {
	    ...
	    for (var i = 0; i < data.length; i++) {
	        ...
	        var visible = (0, _segmentVisible2.default)(series, pointData.fields, i);
	        if ((0, _isNumber2.default)(value) && visible !== false) {
	            sum += Math.abs(value);
	        }
	    }
...
/***/ function(module, exports) {
	...
	module.exports = require("./segment-visible");
