...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColumnsContainer = (function () {
	    ...
	    ColumnsContainer.prototype.refresh = function () {
	        this.lockedColumns.reset(this.columns().filter(function (x) { return x.locked === true; }));
	        this.nonLockedColumns.reset(this.columns().filter(function (x) { return !x.locked; }));
	    };
...
/******/ })));
//# sourceMappingURL=columns-container.js.map